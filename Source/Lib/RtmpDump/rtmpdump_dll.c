...
int
RtmpDumpMain(int tag, DownloadProgressCallback callback, char * logFileName, char * flvFileName, char *paramRtmp, char *paramPlayPath)
#else
int
main(int argc, char **argv)
#endif
...
#ifdef DLL
      nStatus = Download(tag, callback,
                         &rtmp, file, dSeek, dLength, duration, bResume,
